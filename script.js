...
let produtos = [];  // Cria um array vazio que irá conter os produtos (nome e valor).
...
const valorInput = document.getElementById("valor");  // Captura o campo de entrada de valor do produto.
